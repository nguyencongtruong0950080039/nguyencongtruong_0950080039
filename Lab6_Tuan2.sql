...
go
GO
SELECT * FROM cau1('Galaxy V21')
GO
-----------------------câu 2-------------
go
CREATE FUNCTION c2(@x DATE, @y DATE)
RETURNS TABLE
AS
RETURN 
...
go
GO
SELECT * FROM c2('2019-02-01', '2020-1-1')
GO
...
go
go
SELECT * FROM cau4(N'Vật tư')
go

--cau5--
go
CREATE FUNCTION cau5(@address NVARCHAR(100))
RETURNS TABLE
AS
RETURN
SELECT *
...
go
go
SELECT * FROM cau6(2018,2019)
go
-----------------Cau7------------------

--cau7--
go
CREATE FUNCTION cau7 
(
...
go
go
SELECT * FROM cau7('Samsung',0)
go

--cau 8--
go
CREATE FUNCTION Cau8
(
    @ngayNhap DATE
)
RETURNS TABLE
...
go
go
SELECT * FROM Cau9(1,1000000000,'Samsung')
go
